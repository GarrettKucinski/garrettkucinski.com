...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Garrett Kucinski - Senior Software Engineer
        </title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software designer, founding engineer, and amateur astronaut.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Garrett, a software designer and entrepreneur based in Phoenix. I’m a founding engineer at Integrate Space Corp. where we develop
            technologies that powers the space industry and helps organizations get to space.
          </p>
